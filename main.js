...
void main(void)
{
  ...
  c = Julia(B, A);
  oColor = vec4(c * 30.0 / 255.0, c * 0.01 / 255.0, c * 20.0 / 255.0, 1.0);
}
`;
...
function webGLStart () {
  // default cell width
  document.getElementById('inputfractalSpeed').value = 30.0;
  document.getElementById('inputfractalSize').value = 0.8;
